...
{
    public partial class ExhibitionDetail : PhoneApplicationPage
    {
        ...
        {
            NavigationService.Navigate(new Uri("/View/Exhibiton/TranformExhibition.xaml?ExhibitionId=" + ExhibitionId.Text, UriKind.Relative));
        }
