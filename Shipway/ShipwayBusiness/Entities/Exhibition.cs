...
namespace ShipwayBusiness.Entities
{
    public class Exhibition
    {
        ...
        public string ProvinceSenderId { get; set; }
        public string DistrictSenderId { get; set; }
        public string WardSenderId { get; set; }
        public string ProvinceReceiveId { get; set; }
        public string DistrictReceiveId { get; set; }
        public string WardReceiveId { get; set; }
        public int? NumberOfFailedDeliveries { get; set; }
    }
